        ...
        <div class="row">
            <section class="col-12">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <br>
                        <a href="http://localhost/B4/projet/L3/Code/accueil/nav_pilote/CRUD_Etudiant/addAuthEtudiant.php" class="btn btn-primary">Ajouter un étudiant</a>
                        <?php
                        ...
                        <br>
                            <tr>
                                ...
                                <td><?= $etudiant['Mdp'] ?></td>
                                <td><a href="http://localhost/B4/projet/L3/Code/accueil/nav_pilote/CRUD_Etudiant/editEtudiant.php?Id_Etudiant=<?= $etudiant['Id_Etudiant'] ?>"><i class="fa duotone fa-pencil"></i></a></td> 
                                <td><a href="http://localhost/B4/projet/L3/Code/accueil/nav_pilote/CRUD_Etudiant/deleteEtudiant.php?Id_Etudiant=<?= $etudiant['Id_Etudiant'] ?>"><i class="fa solid fa-trash"></i></a></td>
                            </tr>
                        <?php
                        }
                        ?>
