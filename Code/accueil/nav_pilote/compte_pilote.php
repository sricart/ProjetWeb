    ...
    <header>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="sous-menu">
                            <ul>
                                <li>
                                    <a href="http://localhost/L3/code/accueil/nav_pilote/entreprises_pilote.php"> Entreprises </a>
                                </li>
                                <li>
                                    <a href="http://localhost/L3/code/accueil/nav_pilote/offres_pilote.php"> Offres </a>
                                </li>
                            </ul>
                        </div>  
                    </li>
        ...
        <footer>
            <ul>
                ...
                <li>
                    <a href="http://localhost/accueil/nav_pilote/footer/cgu.php">CGU</a> 
                </li>
            </ul>
        </footer>
