...
<html lang="fr">
    <head>
        <meta charset="utf-8">
        <meta name="description" content="Page avec la liste des entreprises pour le pilote">
        <meta name="keywords" content="entreprise pilote">
    ...
    <header>
        ...
        <nav class="nav-bar">
            <ul>
                ...
                <li>
                    <a href="http://localhost/code/accueil/nav_pilote/etudiants_pilote.php">Etudiants</a>                    </li>
                <li>
                    ...
                    <div class="sous-menu">
                        <ul>
                            ...
                            <li>
                                <a href="http://localhost/code/accueil/nav_pilote/offres_pilote.php"> Offres </a>                                </li>
                        </ul>
                    </div>  
                </li>
                <li>
